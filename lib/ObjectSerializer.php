...
use Obada\Client\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     * @param string $type   the ObadaToolsType of the data
     * @param string $format the format of the ObadaTools type of the data
     *
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Obada\Client\Model\\' . $data->{$discriminator};
