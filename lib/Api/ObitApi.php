...
class ObitApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\NewObit $new_obit new_obit (optional)
     *
     ...
     *
     * @param  \OpenAPI\Client\Model\NewObit $new_obit (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $serial_number_hash Query argument that filters by serial number hash (optional)
     * @param  string $obit_status Query argument that filters by obit status (optional)
     * @param  string $manufacturer Query argument that filters by manufacturer (optional)
     * @param  string $part_number Query argument that filters by part number (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InlineResponse2001|\OpenAPI\Client\Model\NotFound
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InlineResponse2001|\OpenAPI\Client\Model\NotFound, HTTP status code, HTTP response headers (array of strings)
     */
