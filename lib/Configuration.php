...
class Configuration
{
    ...
    /**
     * User agent of the HTTP request, set to "Obada-Generator/{version}/PHP" by default
     *
     * @var string
     */
    protected $userAgent = 'Obada-Generator/1.0.0/PHP';
    ...
    {
        $report  = 'PHP SDK (Obada\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the Obada document: 0.0.1' . PHP_EOL;
